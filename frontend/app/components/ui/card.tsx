...
export const DirectionAwareHover = ({
  ...
  return (
    <motion.div
      ...
      ref={ref}
      className={cn(
        "md:h-96 w-60 h-80 md:w-72 bg-gray-100 rounded-lg overflow-hidden group/card relative",
        className
      )}
    >
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <motion.div
            ...
            className={cn("text-white absolute bottom-4 left-4 z-40 pr-4", childrenClassName)}
          >
            {children}
          </motion.div>
        </motion.div>
